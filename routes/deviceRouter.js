...
router.post('/putUslugiprice1', deviceController.putUslugiprice1)
...
router.post('/putUsl', deviceController.putUsl)
...
router.post('/putPhone', deviceController.putPhone)
router.post('/crteatePhone', deviceController.crteatePhone)
router.delete('/delPhone/:id', deviceController.delPhone)
...
router.post('/putKontacts', deviceController.putKontacts)

router.get('/getKontacts', deviceController.getKontacts)
